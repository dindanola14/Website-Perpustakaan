    ...
    <head>
        ...
        <body>
            ...
            <form action="proses_tambah_buku.php" method="post" enctype="multipart/form-data">
                Nama Buku :
                <input type="teks" name="nama_buku" value="" class="form-control">
                Pengarang :
                <input type="teks" name="pengarang" value="" class="form-control">
                Deskripsi :
                <input type="teks" name="deskripsi" value="" class="form-control">
                Foto :
