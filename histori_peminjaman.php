...
<?php
    ...
    while($dt_buku=mysqli_fetch_array($qry_buku)){
        ...
        if(mysqli_num_rows($qry_cek_kembali)>0){
            ...
            $button_kembali="<a href='kembali.php?id=".$dt_histori['id_peminjaman_buku']."' class='btn btn-warning' onclick='return confirm(\"Apakah Anda Yakin Untuk Mengembalikan?\")'>Kembalikan</a>";
        }
 ?>
 <tr>
    <td><?=$no?></td><td><?=$dt_histori['tanggal_pinjam']?></td>
